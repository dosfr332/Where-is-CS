...
const dmsRegEx: RegExp = /^(?<dmsLat>-?(?:[0-9]|[1-8][0-9]|90))(?:(\s?[°d]\s?)|\s)(?<dmsLatMin>[0-5][0-9]|[0-9])(?:(\s?['′"`m]\s?)|\s)(?<dmsLatSec>[0-5][0-9]|[0-9])(?:\s?[″'"s])?\s?(?<dmsLatDir>[NS]|[ns])?[,;\s]?\s+(?<dmsLong>-?(?:[0-9]|[1-9][0-9]|1[0-7][0-9]|180))(?:(\s?[°d]\s?)|\s)(?<dmsLongMin>[0-5][0-9]|[0-9])(?:(\s?['′`"m]\s?)|\s)(?<dmsLongSec>[1-5][0-9]|[0-9])(?:\s?['″"s])?\s?(?<dmsLongDir>[EW]|[ew])?(?:\s(?<label>[a-zs A-Z\s\d]*))?$/;
const dmRegEx: RegExp = /^(?<ddmLat>-?(?:[0-9]|[1-8][0-9]|90))(?:\s?[°d]\s?|\s)(?<ddmLatMin>[0-5]?[0-9](?:\.\d{1,6})?)(?:\s?['"′m]?\s?)(?<ddmLatDir>[NS]|[ns])?[,;\s]?\s+(?<ddmLong>-?(?:[0-9]|[1-9][0-9]|1[0-7][0-9]|180))(?:\s?[°d]\s?|\s)(?<ddmLongMin>[0-5]?[0-9](?:\.\d{1,6})?)(?:\s?['"′m]?\s?)(?<ddmLongDir>[EW]|[ew])?(?:\s(?<label>[a-zs A-Z\s\d]*))?$/;
const directionRegEx: RegExp = /^(?<dirLat>(?:[0-9]|[1-8][0-9]|90)(?:\.\d{1,6})?)['"]?\s*(?<dirLatDir>[NS]|[ns])[,;\s]?\s+(?<dirLong>(?:[0-9]|[1-9][0-9]|1[0-7][0-9]|180)(?:\.\d{1,6})?)['"]?\s?(?<dirLongDir>[EW]|[ew])(?:\s(?<label>[a-zs A-Z\s\d]*))?$/;
...
const dmsRegExReverse: RegExp = /^(?<dmsLong>-?(?:[0-9]|[1-9][0-9]|1[0-7][0-9]|180))(?:(\s?[°d]\s?)|\s)(?<dmsLongMin>[0-5][0-9]|[0-9])(?:(\s?['`"m]\s?)|\s)(?<dmsLongSec>[0-9]|[0-5][0-9])(?:\s?['″"s])?\s?(?<dmsLongDir>[EW]|[ew])?[,]?\s+(?<dmsLat>-?(?:[0-9]|[1-8][0-9]|90))(?:(\s?[°d]\s?)|\s)(?<dmsLatMin>[0-5][0-9]|[0-9])(?:(\s?['`"m]\s?)|\s)(?<dmsLatSec>[1-5][0-9]|[0-9])(?:\s?['″"s])?\s?(?<dmsLatDir>[NS]|[ns])?(?:\s(?<label>[a-zs A-Z\s\d]*))?$/;
const dmRegExReverse: RegExp = /^(?<ddmLong>-?(?:[0-9]|[1-9][0-9]|1[0-7][0-9]|180))(?:\s?[°d]\s?|\s)(?<ddmLongMin>[0-5]?[0-9](?:\.\d{1,6})?)(?:\s?['"′m]?\s?)(?<ddmLongDir>[[EW]|[ew])?[,;]?\s+(?<ddmLat>-?(?:[0-9]|[1-8][0-9]|90))(?:\s?[°d]\s?|\s)(?<ddmLatMin>[0-5]?[0-9](?:\.\d{1,6})?)(?:\s?['"′m]?\s?)(?<ddmLatDir>[NS]|[ns])?(?:\s(?<label>[a-zs A-Z\s\d]*))?$/;
const directionRegExReverse: RegExp = /^(?<dirLong>(?:[0-9]|[1-9][0-9]|1[0-7][0-9]|180)(?:\.\d{1,6})?)['"]?\s?(?<dirLongDir>[EW]|[ew])[,;]?\s+(?<dirLat>(?:[0-9]|[1-8][0-9]|90)(?:\.\d{1,6})?)['"]?\s*(?<dirLatDir>[NS]|[ns])(?:\s(?<label>[a-zs A-Z\s\d]*))?$/;
