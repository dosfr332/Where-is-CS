...
const dmsRegEx: RegExp = /^(?<dmsLat>-?(?:[0-9]|[1-8][0-9]|90))(?:([°d]\s?)|\s)(?<dmsLatMin>[0-5][0-9]|[0-9])(?:(['"m]\s?)|\s)(?<dmsLatSec>[0-5][0-9]|[0-9])(?:['"s])?\s?(?<dmsLatDir>[NS])?[,;\s]?\s+(?<dmsLong>-?(?:[0-9]|[1-8][0-9]|90))(?:([°d]\s?)|\s)(?<dmsLongMin>[0-5][0-9]|[0-9])(?:(['"m]\s?)|\s)(?<dmsLongSec>[0-9]|[0-5][0-9])(?:['"s])?\s?(?<dmsLongDir>[EW])?(?:\s(?<label>[a-zs A-Z\s]*))?$/;
...
const dmsRegExReverse: RegExp = /^(?<dmsLong>-?(?:[0-9]|[1-8][0-9]|90))(?:([°d]\s?)|\s)(?<dmsLongMin>[0-5][0-9]|[0-9])(?:(['"m]\s?)|\s)(?<dmsLongSec>[0-9]|[0-5][0-9])(?:['"s])?\s?(?<dmsLongDir>[EW])?[,]?\s+(?<dmsLat>-?(?:[0-9]|[1-8][0-9]|90))(?:([°d]\s?)|\s)(?<dmsLatMin>[0-5][0-9]|[0-9])(?:(['"m]\s?)|\s)(?<dmsLatSec>[0-5][0-9]|[0-9])(?:['"s])?\s?(?<dmsLatDir>[NS])?(?:\s(?<label>[a-zs A-Z\s]*))?$/;
